...
namespace OnlineTicariOtomasyon.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d7 = deger7;
            var deger8 = (from x in c.Uruns orderby x.UrunSatis descending select x.UrunAd).FirstOrDefault();
            ViewBag.d8 = deger8;
            ///////////////////////////////////////////
            var deger9 = (from x in c.Uruns orderby x.UrunSatis ascending select x.UrunAd).FirstOrDefault();
            ViewBag.d9 = deger9;
